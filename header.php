...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>SIG WISATA JAWA TIMUR</title>

	<link rel="icon" href="admin/img/jawatimur.png">
	...
	<header id="header">
		...
		<div class="container main-menu">
			<div class="row align-items-center justify-content-between d-flex">
				<div id="logo">
					<a href="index.php"><img src="admin/img/jawatimur.png" width="50px" height="50px" alt="" title="" /></a>
				</div>
